package TbLoopWrongStoreCompletion;
...
(* synthesize *)
module mkTbLoopWrongStoreCompletion(Empty);
    ...
    rule unexpectedlyAccepted(step == 7);
        $display("wrong store completion unexpectedly accepted");
        $finish(1);
    endrule
endmodule
